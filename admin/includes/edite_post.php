  ...
  if(isset($_POST['update_post'])){
   ...
   // $post_category=$_POST['post_category_id'];
    ...
    if(empty($post_image)){
        ...
        while ($row1 = mysqli_fetch_assoc( $select_image_query)) {
            $post_image=$row['post_image'];
      ...
      echo 'Post Updated: '."<a href='../post.php?p_id= $the_post_id'>View the Post</a> Or <a href='posts.php'>Edite Other Post</a>"; 
  }
...
<select name="post_status">
    ...
    ?>
     ...
     <div class="form_group">
        ...
        <input value="<?php echo $post_tag ?>" type ="text" class="form-control"
               name="post_tags">
    </div>
    <div class="form_group">
